...
<table style="width:100%">
    <tr>
        <td>Fecha desde</td>
        <td><input type="text" value="<?=$fecha_desde ? date('Y-m-d', $fecha_desde) : '';?>" readonly="readonly" /></td>
    </tr>
    <tr>
        <td>Fecha hasta</td>
        <td><input type="text" value="<?=$fecha_hasta ? date('Y-m-d', $fecha_hasta) : '';?>" readonly="readonly" /></td>
    </tr>
    <tr>
        <td style="border:0.1pt solid #000;" colspan="2">Fideicomiso</td>
...
<?php } ?>
    ...
    <tr>
        ...
        <td style="border:0.1pt solid #000;" width="20">$</td>
...
<?php } ?>
    ...
    <tr>
        ...
        <td style="border:0.1pt solid #000;" width="20">#</td>
<?php foreach($arr_reporte as $item) { ?>
        <td style="border:0.1pt solid #000;"><?=number_format($item['TOTAL_CASOS'], 0 )?></td>
<?php } ?>
    </tr>
</table>
</div>
