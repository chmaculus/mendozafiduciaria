                        ...
                        $.unblockUI({
                            onUnblock: function(){ 
                                jAlert('Operacion Exitosa.', $.ucwords(_etiqueta_modulo),function(){
                                    ...
                                    RefreshTable('#datatable', _creditos.URL +"/x_get_datatable");
                                });
                            } 
                        }); 
                    }, 500);
...
function cargarResults(){
    ...
    var settings = {
        ...
        'bSort': true,
        "oLanguage": {
            "sUrl": __plugs['datatables'].dir + "dataTables.es.txt"
        },
        "bProcessing": true,
        "aoColumns": [
          null,
        ...
        "sAjaxSource": _creditos.URL + "/x_get_datatable",
