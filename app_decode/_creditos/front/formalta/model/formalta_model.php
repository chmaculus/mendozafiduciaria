...
class formalta_model extends credito_model {
    ...
    function get_credito_from_id($id){
        ...
        $intCuotas = $credito['INTERES_CUOTAS'];
        $credito['CAPITAL_VTO'] = date("Y-m-d", strtotime($credito['CAPITAL_VTO']." +".$intCuotas." month"));
        $credito['INTERES_VTO'] = date("Y-m-d", strtotime($credito['CAPITAL_VTO']." +".$intCuotas." month"));
