...
<div class="nuevafact_form">
    ...
    <div class="button-a blue mostrarBodegas" style="float:left; margin-top:10px;"><span id="texto_boton">Calcular datos Bodegas</span></div>    
    ...
    <div class="elem elem_med">
        <label class="der">Litros Asignados:</label>
        <div class="indent formtext">
            <input type="text" class="tip-right" title="" id="litros" value="<?php echo (isset($entidad['DESTINO']) ? $entidad['DESTINO'] : "" )  ?>" >
        </div>
    </div>
    <!--    <div class="elem elem_med">
    ...
    <div class="elem elem_med">
        ...
        <div class="indent formtext">
            <input type="text" class="tip-right" title="" id="porcentaje_iva" value="<?php echo (isset($entidad['DESTINO']) ? $entidad['DESTINO'] : "" ) ?>">
        </div>
    </div>
