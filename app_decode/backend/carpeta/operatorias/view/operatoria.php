<ul class="toolbar">
    ...
    <li class="tb_ope" data-top='ope'><div>Tipos de Operatorias</div></li>
    <li class="tb_chk" data-top='chk'><div>Checklist</div></li>
    <div class="tb_sep"></div>
    <li class="tb_lis" data-top='lis'><div>Listado</div></li>
    <li class="tb_fil" data-top='fil'><div>Agregar Campos</div></li>
