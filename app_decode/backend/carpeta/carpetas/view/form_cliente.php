        ...
        <div class="grid-1" id="frmagregar">
           ...
           <div class="form">
                <form method="post" enctype="multipart/form-data" id="customForm" >
                    ...
                    <input type="hidden" id="provinciahcli" value="0" />
                    <input type="hidden" id="localidadhcli" value="0" />
                    ...
                    <div class="elem elem_med" >
                        ...
                        <div class="indent">
                        <select class="validate[required] chzn-select medium-select select" id="provinciacli" data-prompt-position="topLeft">
                    ...
                    <div class="elem elem_med">
                           ...
                           <div class="indent" id="div_subrubrocli">
                            <select class="chzn-select medium-select select" id="subrubrocli" data-prompt-position="topLeft">
                    ...
                    <div class="group_more">Agregar Contacto</div>
                     ...
                     <div class="elem btns">
                          <input id="sendcli" name="sendcli" type="submit" class="button-a gray" value="Enviar" /> &nbsp;&nbsp;
