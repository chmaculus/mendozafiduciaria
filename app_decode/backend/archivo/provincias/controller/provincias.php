...
class provincias extends main_controller{
    function provincias(){
        $this->mod = $this->model("provincias_model");
    }
    ...
    function init(){
        ...
        $id_permiso = 1; // permiso de acceso a este modulo (fid_permisos)
        ...
        $datax['etiqueta_modulo'] = "Provincias";
    ...
    function _obtener_main($arr_permiso_mod){
        ...
        $data['modulo'] =  "";
        $data['etiqueta_mod'] =  "Provincia";
                
        //return $this->view("provincias", $data);
        /* permiso mostrar */
    ...
    function x_get_datatable(){
        $data = $this->mod->get_datatable(array("ID","PROVINCIA","ID"));
