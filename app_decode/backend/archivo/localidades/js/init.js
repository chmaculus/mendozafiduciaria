$(document).ready(function(){
    ...
    $('#send').on('click', function(event) {
       ...
       if ( !$("#customForm").validationEngine('validate') )
        ...
        $.ajax({
            url : _localidades.URL + "/x_sendobj",
            data : {
                obj:obj
            },
            dataType : "json",
                        ...
                        $.unblockUI({
                            onUnblock: function(){ 
                                jAlert('Operacion Exitosa.', $.ucwords(_etiqueta_modulo),function(){
                                    ...
                                    RefreshTable('#datatable', _localidades.URL +"/x_get_datatable");
                                });
                            } 
                        }); 
                    }, 500);
...
function cargarResults(){
    ...
    var settings = {
        ...
        "sAjaxSource": _localidades.URL+ "/x_get_datatable",
...
function fillFormEdit(obj){
    $("#idh").val(obj.ID);
    $("#nom").val(obj.LOCALIDAD);
    $("#provincia").val(obj.ID_PROVINCIA).trigger("chosen:updated");
}
