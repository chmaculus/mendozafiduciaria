...
class localidades extends main_controller{
    function localidades(){
        $this->mod = $this->model("localidades_model");
    }
    ...
    function init(){
        ...
        $id_permiso = 2; // permiso de acceso a este modulo (fid_permisos)
        ...
        $datax['etiqueta_modulo'] = "Departamentos";
    ...
    function _obtener_main($arr_permiso_mod){
        ...
        $data['etiqueta_mod'] =  "Departamento";
        $data['lst_provincias'] = $this->x_getprovincias();
        //return $this->view("localidades", $data);
        /* permiso mostrar */
    ...
    function x_getprovincias(){
        ...
        //$tmp = trim(json_encode($obj?$obj:array()));
        $tmp = $obj?$obj:array();
        return $tmp;
    }
