<?php
class localidades_model extends main_model{
    public $_tablamod = "fid_localidades";
    ...
    function prev_consulta($cols){
        ...
        $tb = $this->_tablamod;
        $this->_db->select("$tb.ID, PROVINCIA, $tb.LOCALIDAD, $tb.ID as opciones");
        $this->_db->join("fid_provincias p","p.ID = ".$this->_tablamod.".ID_PROVINCIA");
    }
