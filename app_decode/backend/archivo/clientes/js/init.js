        ...
        if (top == 'add') {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#mayorista-lista").change(function () {
                        if ($("#mayorista-lista").val() == "0") {
                            $("#limite-visible").hide();
                        }
                        if ($("#mayorista-lista").val() == "1") {
                            $("#limite-visible").show();
                            $("#limite-mayorista").val(0);
                        }
                    });
                    ...
                    $("#mayorista-lista").chosen({disable_search_threshold: 5});
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#input-retencion").val($("#rete").val());
                    $("#limite-mayorista").val($("#limi_m").val());
                    $("#mayorista-lista").val($("#mayo").val()).trigger("chosen:updated");
