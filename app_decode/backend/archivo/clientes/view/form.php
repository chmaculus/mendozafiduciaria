        ...
        <div class="content-gird">
            <div class="form">
                <form method="post" enctype="multipart/form-data" id="customForm" >
                    ...
                    <input type="hidden" id="mayo" value="<?php echo (isset($entidad["MAYORISTA"]) ? $entidad["MAYORISTA"] : "") ?>" />
                    <input type="hidden" id="rete" value="<?php echo (isset($entidad["RETENCION"]) ? $entidad["RETENCION"] : "") ?>" />
                    <input type="hidden" id="limi_m" value="<?php echo (isset($entidad["LIMITE_M"]) ? $entidad["LIMITE_M"] : "") ?>" />
                    ...
                    <div style="margin-top: 10px;" class="elem elem_med" >
                        <label>Tipo:</label>
                        <div class="indent">
                            <select class="validate[required] chzn-select medium-select select" id="mayorista-lista" data-prompt-position="topLeft">
                    ...
                    <div id="limite-visible" style="display:none;">
                    <div class="elem elem_med">
                        <label>Limite:</label>
                        <div class="indent formtext">
                            <input type="text" class="tip-right" title="Ingrese Valor" id="limite-mayorista" data-prompt-position="centerRight" value="<?php // echo ( isset($entidad['CBU']) ? $entidad['CBU'] : "") ?>"> 
                        </div>
                    </div>                    
                    </div>                    
