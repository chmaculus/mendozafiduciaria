                        ...
                        $.unblockUI({
                            onUnblock: function(){ 
                                jAlert('Operacion Exitosa.', $.ucwords(_etiqueta_modulo),function(){
                                    ...
                                    RefreshTable('#datatable', _provincias.URL +"/x_get_datatable");
                                });
                            } 
                        }); 
                    }, 500);
...
function cargarResults(){
    ...
    var settings = {
        ...
        "sAjaxSource": _provincias.URL + "/x_get_datatable",
...
//console.dir(_this_app);
function editar(id){
        
    $("#label_action").html("Editar");  
    $.ajax({
        url : _provincias.URL + "/x_getobj",
        async: false,
        data : {
            id : id
        },
