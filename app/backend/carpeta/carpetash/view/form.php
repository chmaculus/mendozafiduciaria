 ...
 <div class="content-form">
    ...
    <div class="grid-1" id="frmagregar">
       ...
       <div class="form">
            ...
            <?php if(is_array($lst_etapas_op)): ?>
            <div class="elem elem_med" >
                <label>Etapa Actual:</label>
                <div class="indent">
                <select class="chzn-select medium-select select" id="etapa_actual" data-prompt-position="topLeft">
                    <option value="">Elegir Etapa</option>
                    <?php foreach($lst_etapas_op as $rs_prov): ?>
                    <option data-connection="<?php echo $rs_prov["ID"] ?>" value="<?php echo $rs_prov["ID"] ?>"><?php echo $rs_prov["NOMBRE"] ?></option>
                    <?php endforeach; ?>
                </select>   
                </div>
            </div>
    ...
    <?php if( isset($entidad['ID_PROCESO']) && $entidad['ID_PROCESO']=='2' ): ?>
    ...
    <div id="vtab">
        <ul>
            <li class="checklist <?php echo "etapa_ready" ?>"><span>Inscripción</span></li>
            <li class="inicial <?php echo "etapa_ready" ?>"><span>Control Inicial</span></li>
            <li class="garantia <?php echo "etapa_ready" ?>"><span>Garantías</span></li>
            <li class="sectores <?php echo "etapa_ready" ?>" ><span>Sectores de Análisis</span></li>
            <li class="elevacion <?php echo "etapa_ready" ?>"><span>Elevación</span></li>
            <li class="comite <?php echo "etapa_ready" ?>"><span>Comité</span></li>
            <li class="c_contrato <?php echo "etapa_ready" ?>"><span>Conf. Contrato</span></li>
            <li class="contrato <?php echo "etapa_ready" ?>"><span>Firma Contrato</span></li>
            <li class="altacredito <?php echo "etapa_ready" ?>"><span>Alta de Crédito</span></li>
            <li class="desembolsos <?php echo "etapa_ready" ?>"><span>Desembolsos</span></li>
        </ul>
