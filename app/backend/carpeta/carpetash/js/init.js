    ...
    $(".toolbar li:not(.sub)").click(function(e){
            ...
            if (top == 'lis_su_2'){
                ...
                $.ajax({
                    ...
                    url : _carpetash.URL + "/x_get_id_accion_pendiente",
                    data : {
                        idope:_array_obj.ID
                    },
                    dataType : "json",
                ...
                $.ajax({
                        url : _carpetash.URL + "/x_getetapas_menor",
                        data : {
                        ...
                        success : function(data1){
                            ...
                            $(".x_area").click(function(e1){
                                ...
                                $.ajax({
                                    url : _carpetash.URL + "/x_getetapas_menor2",
                                    data : {
                                        etapa: etapa_in,
                                        idope: _array_obj.ID
                                    },
                                            ...
                                            jConfirm('Esta seguro de realizar esta Asignación1?.', $.ucwords(_etiqueta_modulo),function(r){
                                                if(r==true){
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url : _carpetash.URL + "/x_actualizar_operacion_atras",
                                                        data : {
               ...
               _array_chk = {};
                ...
                $.ajax({
                    url : _carpetash.URL + "/x_getform_addentidad",
                    type : "post",
                    success : function(data){
                        ...
                        */
                        ...
                        $('.send').on('click', function(event){
                            ...
                            obj = {
                                ...
                                arr_obs:arr_obs,
                                arr_chk:arr_chk,
                                ID_ETAPA_ACTUAL:$("#etapa_actual option:selected").val(),
                                //ID_ETAPA_ACTUAL:1,
                                        ...
                                        jAlert('Operacion Exitosa.', $.ucwords(_etiqueta_modulo),function(){
                                            ...
                                            */
                                            ...
                                            $('.asignar').on('click', function(event){
                                                event.preventDefault();
                                                $.ajax({
                                                    url : _carpetash.URL + "/x_getenviar_a1",
                                                    data : {
                                                    ...
                                                    success : function(data1){
                                                        ...
                                                        if(data1){
                                                            $.each(data1, function (index, value){
                                                                ...
                                                                if (value.IID!=_USUARIO_SESION_ACTUAL || 1){
                                                        ...
                                                        $(".x_area").click(function(e1){
                                                            ...
                                                            $.ajax({
                                                                url : _carpetash.URL + "/x_getenviar_a2",
                                                                data : {
                                                                    id_area:iid,
                                                                ...
                                                                success : function(datar){
                                                                    ...
                                                                    $(".link_asignar").click(function(e){
                                                                        ...
                                                                        jConfirm('Esta seguro de realizar esta Asignación2?.', $.ucwords(_etiqueta_modulo),function(r){
                                                                            if(r==true){
                                                                                var id_usuario = iid;
                                                                                //nueva etapa
                                                                                var new_etapa = 1;
                                                                                ...
                                                                                $.ajax({
                                                                                    ...
                                                                                    url : _carpetash.URL + "/x_actualizar_operacion",
                                                                                    data : {
                                                                                        OPERACION:_array_obj.ID,
                        ...
                        if(data.CARTERADE){
                            ...
                            if (_USUARIO_SESION_ACTUAL==data.CARTERADE){
                                jConfirm('Esta seguro de recuperar esta carpeta??.', 'Carpetas',function(r){
                                    if(r==true){
                                        $.ajax({
                                            url : _carpetash.URL + "/x_recuperar_carpeta",
                                            type : "post",
                                            data : {
                                                idope:idope
                                            },
                                           ...
                                           $.unblockUI();
                                            ...
                                            if ( _array_obj.ID_ETAPA_ACTUAL==11 && (jQuery.inArray( _USER_ROL, ['10'])!=-1 ) ){
                                                ...
                                                if( conformidad_fc == 'checked' ){
                                                    ...
                                                    $.ajax({
                                                        url : _carpetash.URL + "/x_get_gar_const",
                                                        data : {
                                                            idope:_array_obj.ID
                                                        },
                                                        async:false,
                                            ...
                                            if ( _array_obj.ID_ETAPA_ACTUAL==12 && _array_obj.ID_PROCESO==1 && (jQuery.inArray( _USER_ROL, ['20'])!=-1 ) ){
                                                ...
                                                if (idcredito){
                                                    //preguntar si se genero el credito
                                                        $.ajax({
                                                            url : _carpetash.URL + "/x_get_tienecuotas",
                                                            data : {
                                                                idcredito:idcredito
                                                            },
                                                            async:false,
                                            ...
                                            if (_array_obj.ID_ETAPA_ACTUAL==3 && (jQuery.inArray( _USER_ROL, ['11'])!=-1 ) ){
                                                ...
                                                if ( (c1 || d1) && (c2 || d2) && (c3 || d3)){
                                                    ...
                                                    $.ajax({
                                                        url : _carpetash.URL + "/x_get_num_garantias",
                                                        data : {
                                                            idope:_array_obj.ID
                                                        },
                                                        type : "post",
                                                ...
                                                if (_array_obj.ID_ETAPA_ACTUAL==9 && (jQuery.inArray( _USER_ROL, ['11'])!=-1 ) ){
                                                    $.ajax({
                                                            url : _carpetash.URL + "/x_get_gar_comite",
                                                            data : {
                                                                idope:_array_obj.ID
                                                            },
                                                            type : "post",
                            ...
                            if (usuario==_USUARIO_SESION_ACTUAL){
                                jConfirm('Esta seguro de borrar este item??.', $.ucwords(_etiqueta_modulo),function(r){
                                    if(r==true){
                                        ...
                                        $.ajax({
                                            url : _carpetash.URL + "/x_delupload_ope",
                                            data : {
                                                idope:idope,
                                                ruta:ruta
                                            },
                ...
                // exportar
                $.ajax({
                    url : _carpetash.URL + "/x_getexportar",
                    type : "post",
                    success : function(data){
                        $.unblockUI();
                        $.fancybox(
...
function loadChild(val){
    if(working==false){
        working = true;
        $.ajax({
              url : _carpetash.URL + "/x_getlocalidad",
              async:false,
              data : {
                    idp : val
              },
...
function loadChild_fid(val){
    if(workingf==false){
        workingf = true;
        $.ajax({
              url : _carpetash.URL + "/x_getoperatoria",
              async:false,
              data : {
                    idf : val
              },
...
function loadChild_gar(val){
    if(workinggar==false){
        workinggar = true;
        $.ajax({
              url : _carpetash.URL + "/x_get_garobjeto",
              async:false,
              data : {
                    idgartipo : val
              },
...
function post_upload(nombre,nombre_tmp, etapa){
    ...
    jAlert('Archivo cargado correctamente. ' + nombre, $.ucwords(_etiqueta_modulo),function(){
        ...
        $('.lista_adjuntos li').last().off().on('click', function(event){
            ...
            //x_borrar_file
            $.ajax({
                url : _carpetash.URL + "/x_borrar_file",
                data : {
                    ruta:ruta
                },
                dataType : "json",
...
function event_add_file(){
    ...
    $('.add_file').on('click', function(event) {
        ...
        */
        ...
        $.ajax({
            url : _carpetash.URL + "/x_getform_adjunto",
            data : {
                etapa:etapa
            },
            type : "post",
...
function agregar_requerimiento(){
    ...
    $(".agregar_req").on('click', function(event){
       $.ajax({
            url : _carpetash.URL + "/x_getform_agregar_requerimiento",
            data : {
                obj:2
            },
            type : "post",
...
function addEventsRequerimientos(idr){
    ...
    if(idr>0){
        $(".lista_reqs_adj a").click(function(e){
            ...
            $.ajax({
                url : _carpetash.URL + "/x_delupload_req",
                data : {
                    idnotareq:idr,
                    ruta:nom
                },
    ...
    if (estadoh_req==3 && (_USER_ROL=='10' || _USER_ROL=='11') ){
        $(".btn_insuf").on('click', function(e){
            ...
            $.ajax({
                url : _carpetash.URL + "/x_update_req",
                data : {
                    idr:id_reqh,
                    arr_up:arr_up,
                    ftra:1
                    ...
                    if ( selectedrowindex != '-1' ){
                        if (selectedrowindex<rowscount){
                                ...
                                if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                    ...
                                    $.ajax({
                                        url : _carpetash.URL + "/x_get_traza_aux1",
                                        type : "post",
                                        data : {
                                        ...
                                        success : function(data){
                                            if (data>0){
                                                ...
                                                jConfirm('Esta seguro de realizar esta acción?.', 'Carpetas',function(r){
                                                    if(r==true){
                                                        $.ajax({
                                                            url : _carpetash.URL + "/x_update_soldese",
                                                            type : "post",
                                                            data : {
                                                                idsol:idsol,
                                                                obj:obj,
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                ...
                                $.ajax({
                                     url : _carpetash.URL + "/x_getform_solicituddesembolso",
                                     data : {
                                          opeid:_array_obj.ID,
                                          idsol:idsol
                                     },
        ...
        success : function(datasolicituddesembolso){
            ...
            $(".send_solicdesembolso").on('click', function(e){
                ...
                if ((m1*1>gc*1) && proceso==1){
                 ...
                 $.ajax({
                      url : _carpetash.URL + "/x_guardar_soldesem",
                      data : {
                          obj:arr_frm_alta
                      },
                      dataType : "json",
...
function agregar_altacredito(){
    ...
    $("#agregar_altacredito").on('click', function(event){
        ...
        $.ajax({
            url : _carpetash.URL + "/x_get_solicitud_de_credito",
            data : {
                idope:idope
            },
            dataType : "json",
            ...
            success : function(dato_dol){
                ...
                $.ajax({
                     url : _carpetash.URL + "/x_getform_altacredito",
                     data : {
                         opeid:_array_obj.ID,
                                ...
                                success : function(datac){
                                    if (datac>0){
                                        ...
                                        */
                                        ...
                                        $.ajax({
                                             url : _carpetash.URL + "/x_guardar_altacredito",
                                             data : {
                                                 obj:arr_frm_alta,
                                                 arr_desem:arr_desem
                                             },
            ...
            adjuntoButton.click(function (event) {
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            $.ajax({
                                url : _carpetash.URL + "/x_getform_adjunto_gar",
                                data : {
                                    etapa:999,
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                ...
                                //cambiar estado
                                $.ajax({
                                    url : _carpetash.URL + "/x_getform_actualizarestadogarantia",
                                    type : "post",
                                    data : {
                                        opeid:id_ope_actual
                                    },
                                    ...
                                    success : function(datafrm_estadogar){
                                        ...
                                        $('.send_cambiarestado_gar').on('click', function(event) {
                                            ...
                                            $.ajax({
                                                url : _carpetash.URL + "/x_actualizar_garantia",
                                                data : {
                                                    idgar:id_garantia,
                                                    obj:obj_edit
                                                },
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                ...
                                $.ajax({
                                     //url : _carpetash.URL + "/x_getform_solicituddesembolso",
                                     url : _carpetash.URL + "/x_getform_garantias",
                                     data : {
                                          opeid:_array_obj.ID,
                                          idgar:idgar
                                     },
                                     ...
                                     success : function(datasolicituddesembolso){
                                        ...
                                        $('#tipo_garantia').bind('change', function(event){
                                         ...
                                         $('.lista_adjuntos li').off().on('click', function(event) {
                                            ...
                                            jConfirm('Esta seguro de borrar este item??.', $.ucwords(_etiqueta_modulo),function(r){
                                                if(r==true){
                                                    //borrar archivo en la bd y fisicamente
                                                    $.ajax({
                                                        url : _carpetash.URL + "/x_delupload_gar",
                                                        data : {
                                                            idgar:idgar,
                                                            descripcion:descripcion
                                                        },
                                         ...
                                         $(".send_guardargarantia").on('click', function(e){
                                            ...
                                            $.ajax({
                                                 url : _carpetash.URL + "/x_guardar_garantia",
                                                 data : {
                                                     obj:objins
                                                 },
                                                 dataType : "json",
                                ...
                                jConfirm('Esta seguro de realizar esta Asignación10?.', $.ucwords(_etiqueta_modulo),function(r){
                                    if(r==true){
                                        ...
                                        $.ajax({
                                            ...
                                            url : _carpetash.URL + "/x_paselibre",
                                            data : {
                                                OPERACION:_array_obj.ID,
