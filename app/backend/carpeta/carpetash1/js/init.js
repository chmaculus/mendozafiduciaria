...
var cont_legales = 0;
var rand_var = Math.round((new Date()).getTime() / 1000)
...
$(document).ready(function(){
    ...
    $(".toolbar li:not(.sub)").click(function(e){
            ...
            if (top == 'lis_su_2'){
                ...
                $.ajax({
                    ...
                    url : _carpetash1.URL + "/x_get_id_accion_pendiente",
                    data : {
                        idope:_array_obj.ID
                    },
                    dataType : "json",
                ...
                $.ajax({
                        url : _carpetash1.URL + "/x_getetapas_menor",
                        data : {
                        ...
                        success : function(data1){
                            ...
                            $(".x_area").click(function(e1){
                                ...
                                $.ajax({
                                    url : _carpetash1.URL + "/x_getetapas_menor2",
                                    data : {
                                        etapa: etapa_in,
                                        idope: _array_obj.ID
                                    },
                                    ...
                                    success : function(datar){
                                        ...
                                        $(".link_asignar_atras").click(function(e){
                                            ...
                                            jConfirm('Esta seguro de realizar esta Asignación1?.', $.ucwords(_etiqueta_modulo),function(r){
                                                if(r==true){
                                                    var id_usuario = iid;
                                                    //nueva etapa
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url : _carpetash1.URL + "/x_actualizar_operacion_atras",
                                                        data : {
               ...
               _array_chk = {};
                ...
                $.ajax({
                    url : _carpetash1.URL + "/x_getform_addentidad",
                    type : "post",
                    success : function(data){
                        ...
                        $("#montoa1").numeric({ negative: false });
                        $("#montoa2").numeric({ negative: false });
                        $("#montoa3").numeric({ negative: false });
                        
                        $("#nombre").focus();
                        
                        init_datepicker('#fcontrato','-3','+5','0',0);
                        
                        
                        $("#fcontrato").blur(function(e){
                            //validar
                            e.preventDefault();
                        ...
                        $('.send').on('click', function(event){
                            ...
                            var arr_desem=[];
                            var montoa1 = $("#montoa1").val()?$("#montoa1").val():0;
                            var montoa2 = $("#montoa2").val()?$("#montoa2").val():0;
                            var montoa3 = $("#montoa3").val()?$("#montoa3").val():0;
                            
                            var suma = parseFloat(montoa1) + parseFloat(montoa2) + parseFloat(montoa3);
                            
                            if (suma*1 > montosol*1){
                                jAlert('La suma de los desembolsos no puede ser mayor al Monto del Contrato.', $.ucwords(_etiqueta_modulo),function(){
                                    //$.unblockUI();
                                    $.unblockUI();
                                });
                                return false;
                            ...
                            var anio1 = $("#anio1 option:selected").text();
                            var anio2 = $("#anio2 option:selected").text();
                            var anio3 = $("#anio3 option:selected").text();
                            
                            if (anio1!='Elegir'){arr_desem.push({obs:'Monto 1',monto:montoa1,anio:anio1});}
                            if (anio2!='Elegir'){arr_desem.push({obs:'Monto 2',monto:montoa2,anio:anio2});}
                            if (anio3!='Elegir'){arr_desem.push({obs:'Monto 3',monto:montoa3,anio:anio3});}

                            console.log('_USUARIO_SESION_ACTUAL: ' + _USUARIO_SESION_ACTUAL);
                                ...
                                success : function(data){
                                    ...
                                    if(data.result>0){
                                        jAlert('Operacion Exitosa.', $.ucwords(_etiqueta_modulo),function(){
                                            ...
                                            if (estado == 2) {
                                                var dato_f = $("#div_altadecredito").html();
                                                $.fancybox({
                                                    "content": "aaa",
                                                    'padding': 35,
                                                    'autoScale': true,
                                                    ...
                                                    'scrolling': 'yes',
                                                    'beforeClose': function() {
                                                        url = "backend/carpeta/carpetas";
                                                        $(location).attr('href', url);
                                                    },
                                                    afterLoad: function() {
                                                //$(".fancybox-inner").
                                                        load_app("creditos/front/formalta", ".fancybox-inner", [cred],
                                                                function() {
                                                                    //$('#jqxgrid').hide();
                                                                    $.unblockUI();
                                                                },
                        ...
                        if(data.CARTERADE){
                            ...
                            if (_USUARIO_SESION_ACTUAL==data.CARTERADE){
                                jConfirm('Esta seguro de recuperar esta carpeta??.', 'Carpetas',function(r){
                                    if(r==true){
                                        $.ajax({
                                            url : _carpetash1.URL + "/x_recuperar_carpeta",
                                            type : "post",
                                            data : {
                                                idope:idope
                                            },
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        var fcontrato = _array_obj.FECHA;
                        fcontrato = fcontrato.split(" ");
                        fcontrato = fcontrato[0].split("-");
                        fcontrato = fcontrato[2] + '/'+ fcontrato[1] +'/'+ fcontrato[0];
                        
                        $("#estado").val(_array_obj.ID_ESTADO).trigger("chosen:updated");
                        
                        $("#fcontrato").val(fcontrato);
                        
                        $("#etapa_actual").val(_array_obj.ID_ETAPA_ACTUAL).trigger("chosen:updated");
                        ...
                        $("#anio1").val(_fecha1).trigger("chosen:updated");
                        $("#anio2").val(_fecha2).trigger("chosen:updated");
                        $("#anio3").val(_fecha3).trigger("chosen:updated");
                        ...
                        $('.send').on('click', function(event) {
                            ...
                            console.log('_USUARIO_SESION_ACTUAL222: ' + _USUARIO_SESION_ACTUAL);
                        ...
                        $('.asignar').on('click', function(event){
                            ...
                            $.ajax({
                                url : _carpetash1.URL + "/x_getenviar_a1",
                                data : {
                                ...
                                success : function(data1){
                                    ...
                                    $(".x_area").click(function(e1){
                                        ...
                                        $.ajax({
                                            url : _carpetash1.URL + "/x_getenviar_a2",
                                            data : {
                                                id_area:iid,
                                            ...
                                            success : function(datar){
                                                ...
                                                if(datar){
                                                    ...
                                                    $.each(datar, function (index, value){
                                                        ...
                                                        */
                                                        ...
                                                        if (1 || value.IID!=_USUARIO_SESION_ACTUAL || ( _array_obj.ID_ETAPA_ACTUAL==13 && _USER_ROL==24 && value.ETAPA=='13' ) || ( _array_obj.ID_ETAPA_ACTUAL==1 && _USER_ROL==10 && value.ETAPA=='3' )  ){
                                                ...
                                                $.fancybox({
                                                    ...
                                                    'scrolling' : 'no',
                                                    'beforeClose': function() { 
                                                        console.log('tmpfancy: ' + tmpfancy);
                                                        if (tmpfancy==1)
                                                            regresar_a_listado_h();
                                                    }
                                                });
                                                if (tmpfancy==1)
                                                    myfancy=1;
                                                ...
                                                $('.adesembolso').on({
                                                    click: function() {
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación3?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                var id_usuario = iid;
                                                                //nueva etapa
                                                                ...
                                                                $.ajax({
                                                                    url : _carpetash1.URL + "/x_actualizar_operacion",
                                                                    data : {
                                                ...
                                                $(".link_asignar").click(function(e){
                                                    ...
                                                    var descripcion;
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación4?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                 var id_usuario = iid;
                                                                //nueva etapa
                                                                var new_etapa = 1;
                                                                var eta_act = $("#etapa_actual option:selected").val();

                                                                new_etapa = eta_act;
                                                                observacion='ENVIADO';
                                                                descripcion='CARGA HISTORICA, ESPERANDO ACEPTACION'
                                                                estado='2'
                                                ...
                                                $('.adelegacionfirmacontrato').on({
                                                    click: function() {
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación5?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                var id_usuario = iid;
                                                                //nueva etapa
                                                                observacion='ENVIADO';
                                                ...
                                                $('.aaltacredito').on({
                                                    click: function() {
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación6?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                var id_usuario = iid;
                                                                //nueva etapa
                                                                observacion='ENVIADO';
                                                ...
                                                $('.afirmacontrato').on({
                                                    click: function() {
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación7?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                var id_usuario = iid;
                                                                //nueva etapa
                                                ...
                                                $('.acontrato').on({
                                                    click: function() {
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación8?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                var id_usuario = iid;
                                                                //nueva etapa
                                                                var new_etapa = 0;
                                                ...
                                                $('.acomite').on({
                                                    click: function() {
                                                        ...
                                                        jConfirm('Esta seguro de realizar esta Asignación9?.', $.ucwords(_etiqueta_modulo),function(r){
                                                            if(r==true){
                                                                var id_usuario = iid;
                                                                var autor = 0;
                                                                //nueva etapa
                            ...
                            if (usuario==_USUARIO_SESION_ACTUAL){
                                jConfirm('Esta seguro de borrar este item??.', $.ucwords(_etiqueta_modulo),function(r){
                                    if(r==true){
                                        ...
                                        $.ajax({
                                            url : _carpetash1.URL + "/x_delupload_ope",
                                            data : {
                                                idope:idope,
                                                ruta:ruta
                                            },
                ...
                // exportar
                $.ajax({
                    url : _carpetash1.URL + "/x_getexportar",
                    type : "post",
                    success : function(data){
                        $.unblockUI();
                        $.fancybox(
    ...
    if (_val_init==1)
        $(".toolbar .tb_add").trigger("click");
    
    if (_val_init!=1 && parseInt(_val_id) > 0 ){
        var rows = $('#jqxgrid').jqxGrid('getrows');
        $.each(rows, function (index, value){
            var selid=0;
            if (value.IDOPE==_val_id){
                selid = value.uid;
                $('#jqxgrid').jqxGrid('selectrow', selid);
                return false;
            }
        });
        $(".toolbar .tb_edi").trigger("click");
...
function loadChild(val){
    if(working==false){
        working = true;
        $.ajax({
              url : _carpetash1.URL + "/x_getlocalidad",
              async:false,
              data : {
                    idp : val
              },
...
function loadChild_fid(val){
    if(workingf==false){
        workingf = true;
        $.ajax({
              url : _carpetash1.URL + "/x_getoperatoria",
              async:false,
              data : {
                    idf : val
              },
...
function loadChild_gar(val){
    if(workinggar==false){
        workinggar = true;
        $.ajax({
              url : _carpetash1.URL + "/x_get_garobjeto",
              async:false,
              data : {
                    idgartipo : val
              },
...
function post_upload(nombre,nombre_tmp, etapa){
    ...
    jAlert('Archivo cargado correctamente. ' + nombre, $.ucwords(_etiqueta_modulo),function(){
        ...
        $('.lista_adjuntos li').last().off().on('click', function(event){
            ...
            //x_borrar_file
            $.ajax({
                url : _carpetash1.URL + "/x_borrar_file",
                data : {
                    ruta:ruta
                },
                dataType : "json",
...
function event_add_file(){
    ...
    $('.add_file').on('click', function(event) {
        ...
        */
        ...
        $.ajax({
            url : _carpetash1.URL + "/x_getform_adjunto",
            data : {
                etapa:etapa
            },
            type : "post",
...
function agregar_requerimiento(){
    ...
    $(".agregar_req").on('click', function(event){
       $.ajax({
            url : _carpetash1.URL + "/x_getform_agregar_requerimiento",
            data : {
                obj:2
            },
            type : "post",
...
function addEventsRequerimientos(idr){
    ...
    if(idr>0){
        $(".lista_reqs_adj a").click(function(e){
            ...
            $.ajax({
                url : _carpetash1.URL + "/x_delupload_req",
                data : {
                    idnotareq:idr,
                    ruta:nom
                },
    ...
    if (estadoh_req==3 && (_USER_ROL=='10' || _USER_ROL=='11') ){
        $(".btn_insuf").on('click', function(e){
            ...
            $.ajax({
                url : _carpetash1.URL + "/x_update_req",
                data : {
                    idr:id_reqh,
                    arr_up:arr_up,
                    ftra:1
                    ...
                    if ( selectedrowindex != '-1' ){
                        if (selectedrowindex<rowscount){
                                ...
                                if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                    ...
                                    $.ajax({
                                        url : _carpetash1.URL + "/x_get_traza_aux1",
                                        type : "post",
                                        data : {
                                        ...
                                        success : function(data){
                                            if (data>0){
                                                ...
                                                jConfirm('Esta seguro de realizar esta acción?.', 'Carpetas',function(r){
                                                    if(r==true){
                                                        $.ajax({
                                                            url : _carpetash1.URL + "/x_update_soldese",
                                                            type : "post",
                                                            data : {
                                                                idsol:idsol,
                                                                obj:obj,
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                ...
                                $.ajax({
                                     url : _carpetash1.URL + "/x_getform_solicituddesembolso",
                                     data : {
                                          opeid:_array_obj.ID,
                                          idsol:idsol
                                     },
        ...
        success : function(datasolicituddesembolso){
            ...
            $(".send_solicdesembolso").on('click', function(e){
                ...
                if ((m1*1>gc*1) && proceso==1){
                 ...
                 $.ajax({
                      url : _carpetash1.URL + "/x_guardar_soldesem",
                      data : {
                          obj:arr_frm_alta
                      },
                      dataType : "json",
...
function agregar_altacredito(){
    ...
    $("#agregar_altacredito").on('click', function(event){
        ...
        $.ajax({
            url : _carpetash1.URL + "/x_get_solicitud_de_credito",
            data : {
                idope:idope
            },
            dataType : "json",
            ...
            success : function(dato_dol){
                ...
                $.ajax({
                     url : _carpetash1.URL + "/x_getform_altacredito",
                     data : {
                         opeid:_array_obj.ID,
                     ...
                     success : function(dataaltacredito){
                        ...
                        $("#alta_int_vto").blur(function(e){
                         ...
                         $(".send_altacredito").on('click', function(e){
                            ...
                            $.ajax({
                                url : _carpetash1.URL + "/x_get_tienecuotas",
                                data : {
                                    idcredito:idcredito
                                },
                                dataType : "json",
                                ...
                                success : function(datac){
                                    if (datac>0){
                                        ...
                                        */
                                        ...
                                        $.ajax({
                                             url : _carpetash1.URL + "/x_guardar_altacredito",
                                             data : {
                                                 obj:arr_frm_alta,
                                                 arr_desem:arr_desem
                                             },
...
function agregar_garantias_1(acc, _array_obj){
    ...
    if(acc=='edi'){
        ...
        var _array_obj = [];
        _array_obj.ID = '999911';
        _array_obj.OBSERVACION_RAND = rand_var;
    }
            ...
            adjuntoButton.click(function (event) {
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            $.ajax({
                                url : _carpetash1.URL + "/x_getform_adjunto_gar",
                                data : {
                                    etapa:999,
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                ...
                                //cambiar estado
                                $.ajax({
                                    url : _carpetash1.URL + "/x_getform_actualizarestadogarantia",
                                    type : "post",
                                    data : {
                                        opeid:id_ope_actual
                                    },
                                    ...
                                    success : function(datafrm_estadogar){
                                        ...
                                        $('.send_cambiarestado_gar').on('click', function(event) {
                                            ...
                                            $.ajax({
                                                url : _carpetash1.URL + "/x_actualizar_garantia",
                                                data : {
                                                    idgar:id_garantia,
                                                    obj:obj_edit
                                                },
                ...
                if ( selectedrowindex != '-1' ){
                    if (selectedrowindex<rowscount){
                            ...
                            if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                                ...
                                $.ajax({
                                     //url : _carpetash1.URL + "/x_getform_solicituddesembolso",
                                     url : _carpetash1.URL + "/x_getform_garantias",
                                     data : {
                                          opeid:_array_obj.ID,
                                          idgar:idgar
                                     },
                                     ...
                                     success : function(datasolicituddesembolso){
                                        ...
                                        $('#tipo_garantia').bind('change', function(event){
                                         ...
                                         $('.lista_adjuntos li').off().on('click', function(event) {
                                            ...
                                            jConfirm('Esta seguro de borrar este item??.', $.ucwords(_etiqueta_modulo),function(r){
                                                if(r==true){
                                                    //borrar archivo en la bd y fisicamente
                                                    $.ajax({
                                                        url : _carpetash1.URL + "/x_delupload_gar",
                                                        data : {
                                                            idgar:idgar,
                                                            descripcion:descripcion
                                                        },
                                         ...
                                         $(".send_guardargarantia").on('click', function(e){
                                            ...
                                            $.ajax({
                                                 url : _carpetash1.URL + "/x_guardar_garantia",
                                                 data : {
                                                     obj:objins
                                                 },
                                                 dataType : "json",
                    ...
                    success : function(datagar){
                        ...
                        $(".send_guardargarantia").on('click', function(e){
                            ...
                            var objins = {
                                ...
                                'DATO_3':$("#dato3").val(),
                                'ID_ESTADO':$("#estado_garantia").val(),
                                'OBSERVACION':_array_obj.OBSERVACION_RAND
                            }
                    ...
                    $.ajax({
                        ...
                        success : function(datar){
                            ...
                            $(".link_asignar").click(function(e){
                                ...
                                jConfirm('Esta seguro de realizar esta Asignación10?.', $.ucwords(_etiqueta_modulo),function(r){
                                    if(r==true){
                                        ...
                                        $.ajax({
                                            ...
                                            url : _carpetash1.URL + "/x_paselibre",
                                            data : {
                                                OPERACION:_array_obj.ID,
...
function regresar_a_listado_h(){
    ...
    */
    ...
    var urlh = "backend/carpeta/carpetas";
