<div class="div_upload_frm">
        ...
        <div class="elem myfile" id="fot_car">
            ...
            <form id="upload_file1" action="backend/carpeta/carpetas/get_file1" target="enviar_archivo" method="post" enctype="multipart/form-data">
                <div class="uploader black">
                    ...
                    <input type="hidden" name="etapa" id="etapa" value="<?php echo $etapa ?>"/>
