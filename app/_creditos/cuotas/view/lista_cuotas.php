<div id="div-list-cuotas">
    <ul class="ul-titulo">
        <li>
                <span class="fecha_sp">FECHA INICIO</span>
                <span class="fecha_sp">FECHA VENC.</span>
            ...
            <li class="cuotas" >
                ...
                <div class="content-segmento">
                    <ul class="ul-titulo-segmento">
                        <li>
                                <span class="fecha_no_select">DESDE</span>
                                <span class="fecha_no_select">HASTA</span>
                    ...
                    <ul class="segmentos-ul">
                        ...
                        <li class="subcuentas">
                                <span class="fecha_no_select"><?= date("d/m/Y", $gasto['FECHA']) ?></span>
                                <span class="fecha_no_select"> &nbsp;</span>
                                ...
                                <span class="dias">GASTOS</span>
                                    ...
                                    <div class="opciones_evento">
                                        <span class="remove" onclick="eliminar_variacion(<?= $gasto['ID'] ?>);">[X]</span>
                                        <span class="remove" onclick="mostrar_variacion(<?= $gasto['ID'] ?>);">[M]</span>
                                    </div>
                        ...
                        <?php foreach ($cuota['SEGMENTOS'] as $segmento) { ?>
                            <li class="subcuentas">
                                <span class="fecha_no_select"><?= date("d/m/Y", $segmento['FECHA_INICIO']) ?></span>
                                ...
                                <?php if ($segmento['TIPO']) { ?>
                                    ...
                                    <div class="opciones_evento">
                                        <span class="remove" onclick="eliminar_variacion(<?= $segmento['_ID_VARIACION'] ?>);">[X]</span>
                        ...
                        <?php foreach ($VARIACIONES as $variacion) { ?>
                            <li class="subcuentas">
                                ...
                                <?php if (isset($segmento['TIPO'])) if ($segmento['TIPO']) { ?>
                                    ...
                                    <div class="opciones_evento">
                                        <span class="remove" onclick="eliminar_variacion(<?= $variacion['ID'] ?>);">[X]</span>
