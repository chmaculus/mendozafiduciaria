        ...
        <div class="row c12 grupo">
            ...
            <div class="c8">
                ...
                <div class="row">
                    ...
                    <div class="c7">
                        <input type="text" class="" id="txtCreditoID-opc" value=""/>
                    </div>
                </div>
                <div class="row">
                    <div class="c5">
        ...
        <div class="row c12 div-intereses grupo">
            ...
            <div class="row intereses">
                    ...
                    <div class=" row">
                        ...
                        <div class="c3">
                            <input type="text" class="" id="txtPeriodicidadCalculoCompensatorio" value="<?= $credito['PLAZO_COMPENSATORIO']?$credito['PLAZO_COMPENSATORIO']:360  ?>"/>
                        </div>
                    </div>   
                    ...
                    <div class="row ">
                        ...
                        <div class="c3">
                            <input type="text" class="" id="txtPeriodicidadCalculoMoratorio" value="<?= $credito['PLAZO_PUNITORIO']?$credito['PLAZO_PUNITORIO']:360 ?>"/>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="c5">
                        ...
                        <div class="c3">
                            <span ><input type="text" class="" id="txtPeriodicidadCalculoPunitorio" value="<?= $credito['PLAZO_MORATORIO']?$credito['PLAZO_MORATORIO']:360 ?>"/></span>
                        </div>
                    </div>       
                </div>                
