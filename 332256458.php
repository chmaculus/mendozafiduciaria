...
if (!$bajax){
   /* $script_ini = '
        <script type="text/javascript">
            ...
            var _'.$_controller.' = {};
            _'.$_controller.' = generic.copy();
            _'.$_controller.'.URL = "'.$_controller_path.'" ;
            _'.$_controller.'.init();
            _this_app =  _'.$_controller.'.copy();
            var generic = new class_generic;
            
                
            start_object("'.$_controller_path.'", "", [], function(){}, function(){}, function(){});
        </script>
    ';*/
    $script_ini = '
        ...
        <script type="text/javascript">
            ...
            var _url_sitio = "'.URL_SITIO.'";
            var _'.$_controller.'  = start_object("'.$_controller_path.'", "", [], function(){}, function(){}, function(){});
...
$global = array(
    ...
    '_plug' => new plug_header($_plug, $_controller),
